...
const testess = () => __awaiter(void 0, void 0, void 0, function* () {
    const salt = yield bcrypt.genSalt(BCRYPT_SALT_ROUNDS);
    console.log(salt);
    const password = "123teste";
    const encryptWord = yield bcrypt.hash(password, salt);
